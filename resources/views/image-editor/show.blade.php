...
@push('styles')
    <link rel="stylesheet" href="{{ mix('pixie/css/main.css') }}"/>
    <script type="text/javascript">
      window.instorexSettings = window.instorexSettings || {}
      window.instorexSettings.googleKey = '{{ config('services.google_webfonts.api_key')}}'
    </script>
@endpush

@section('content')
    <div id="pixieEditor">
        <div id="editor" ng-app="ImageEditor" ng-strict-di>
            ...
            <div ng-controller="MainController" ng-cloak style="height: 100%">
                <section id="right-panels">
                    <section id="objects" class="md-whiteframe-z1" ng-controller="ObjectsPanelController"
                             style="display: none">
                        <h3 ed-toggle-panel-visibility="objects"><span>Layers</span><i class="mdi mdi-expand-less"></i>
                        </h3>
                        <div class="scrollbar-wrapper" ed-pretty-scrollbar ed-scroll-axis="y">
                            <ul class="objects-panel list-unstyled" ui-sortable="sortableOptions" ng-model="objects">
                                <li class="object panel-item" ng-repeat="object in objects"
                                    ng-click="setAsActive(object)" ng-if="!object.ignore">
                                    ...
                                    <i class="mdi mdi-lock-outline lock-object"
                                       ng-class="{ 'not-locked': !object.locked }"
                                       ng-click="toggleLock(object); $event.stopPropagation();"></i>
                                    @{{ spacify(object.name) || spacify(object.type) }}
                                </li>
                                <li ng-if="!canvas.fabric._objects.length" class="text-center"><h4>No layers yet.</h4>
                                </li>
                            </ul>
                        </div>
                    </section>
                    ...
                    <section id="history" class="md-whiteframe-z1 panel-hidden">
                        <h3 ed-toggle-panel-visibility="history"><span>History</span><i class="mdi mdi-expand-less"></i>
                        </h3>
                        <ul class="history-panel list-unstyled" ed-pretty-scrollbar ed-scroll-axis="y">
                            <li class="history-item panel-item" ng-click="history.load(item)"
                                ng-repeat="item in history.all">
                ...
                <section ng-hide="!loading" id="spinner">
                    <md-progress-circular class="md-spinner" md-diameter="100"
                ...
                <section id="left-sidebar" ed-tabs="basics" class="md-whiteframe-z1">
                    ...
                    <div id="tabs">
                        <section id="basics" data-index="1" class="tab">
                            ...
                            {{-- We don't support cropping or resizing , as this would change the size of the images
                             <div ng-controller="CropController" class="basics-item">
                                 ...
                                 <div data-name="crop" class="actions-menu md-whiteframe-z1"
                                     ...
                                     <div class="buttons">
                                         ...
                                         <md-button ng-click="cropper.crop()" class="md-primary md-raised">crop
                                         </md-button>
                                     </div>
                                 </div>
                             </div>
                            ...
                            <div ng-controller="RotateController" class="basics-item">
                                ...
                                <div data-name="rotate" class="actions-menu md-whiteframe-z1"
                                    ...
                                    {{-- We don't support rotating an arbitrary angle
                                    <section class="menu-group">
                                        <div class="md-slider">
                                            <div class="slider-label">Angle</div>
                                            <md-slider aria-label="Angle" step="1" ng-model="angle"
                                                       ng-change="rotate(angle)" min="0" max="360"></md-slider>
                                        </div>
                                        <div class="slider-input">
                                            <input type="number" ng-model="angle" ng-change="rotate(angle)" min="0"
                                                   max="360"/>
                                        </div>
                                    </section>
                                    ...
                                    <div class="buttons">
                                        ...
                                        <md-button ng-click="applyRotation()" class="md-primary md-raised">apply
                                        </md-button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div ng-controller="ResizeController" class="basics-item">
                                ...
                                <div data-name="resize" class="actions-menu md-whiteframe-z1"
                                    ...
                                    <md-checkbox ng-model="usePercentages"
                                                 ng-change="togglePercentages(usePercentages)">Use Percentages
                                    </md-checkbox>
                        ...
                        <section id="text" data-index="2" class="tab" ng-controller="TextController">
                            ...
                            <div class="filter-inputs">
                                ...
                                <md-input-container class="filter-input">
                                    <label>Search</label>
                                    <input type="text" ng-model="filters.family"
                                           ng-change="fonts.paginator.filter(filters)">
                                </md-input-container>
                            </div>

                            <div ng-hide="activeTab !== 'text'" class="pagination md-whiteframe-z1"
                                 ed-fonts-pagination></div>

                            <section class="fonts-preview" ed-pretty-scrollbar ed-scroll-axis="y"
                                     ed-scroll-theme="light">
                                <div class="font" ng-style="{ 'font-family':  font.family }"
                                     ng-repeat="font in fonts.paginator.currentItems"
                                     ng-click="changeFont(font.family, $event)">@{{ font.family }}
                                </div>
                            </section>
                                ...
                                <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                                    ...
                                    <div class="md-slider">
                                        ...
                                        <md-slider aria-label="text opacity" step="0.1" ng-model="opacity"
                                                   ng-change="text.setProperty('opacity', opacity)" min="0"
                                                   max="1"></md-slider>
                                    </div>
                                    <div class="slider-input">
                                    ...
                                    <div class="md-slider">
                                        ...
                                        <md-slider aria-label="text size" step="1"
                                                   ...
                                                   ng-model="fontSize" min="1" max="100"></md-slider>
                                    </div>
                                    <div class="slider-input">
                                    ...
                                    <div class="text-styles">
                                        ...
                                        <div class="text-style-toolbar text-decoration-buttons"
                                             ed-text-decoration-buttons>
                                    ...
                                    <div class="colorpicker">
                                        <md-checkbox class="md-checkbox" ng-model="enableOutline"
                                                     ng-change="text.toggleProperty('stroke', enableOutline)"
                                                     aria-label="Outline">Outline
                                        </md-checkbox>
                                    ...
                                    <div class="md-inputs">
                                        ...
                                        <md-input-container>
                                            ...
                                            <input ng-disabled="!enableOutline" type="number" min="1" max="100"
                                                   ...
                                                   ng-change="text.setProperty('strokeWidth', strokeWidth)">
                                        </md-input-container>
                                    </div>

                                    <div class="buttons">
                                        <md-button ng-click="finishAddingTextToCanvas()" class="md-primary md-raised">
                                            Save
                                        </md-button>
                                        <md-button ng-click="cancelAddingTextToCanvas()" class="md-raised">Cancel
                                        </md-button>
                                    </div>
                                </section>
                            </div>
                            ...
                            <div id="brushes">
                                <div ng-repeat="brush in drawing.availableBrushes"
                                    ...
                                    <img title="@{{ brush }}" class="img-responsive"
                                         ng-src="pixie/images/brushes/@{{brush}}.png"/>
                                </div>
                            </div>
                            ...
                            <div data-name="drawing" class="actions-menu wider md-whiteframe-z1"
                                ...
                                <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                                    ...
                                    <div class="md-slider">
                                        ...
                                        <md-slider aria-label="brush thickness" step="1"
                                                   ng-model="drawing.params.brushWidth"
                                                   ng-change="drawing.setProperty('width', drawing.params.brushWidth)"
                                    ...
                                    <div class="md-slider">
                                        ...
                                        <md-slider aria-label="shadow blur" ng-disabled="!drawing.params.enableShadow"
                                                   step="1" ng-model="drawing.params.shadowBlur"
                                    ...
                                    <div class="slider-input">
                                        <input type="number"
                                               ng-change="drawing.setShadowProperty('blur', drawing.params.shadowBlur)"
                                               ng-disabled="!drawing.params.enableShadow"
                                               ng-model="drawing.params.shadowBlur"/>
                                    </div>

                                    <div class="md-slider">
                                        <div class="slider-label"><span>Offset X</span></div>
                                        <md-slider ng-disabled="!drawing.params.enableShadow" aria-label="shadow blur"
                                                   step="1" ng-model="drawing.params.shadowOffsetX"
                                    ...
                                    <div class="md-slider">
                                        ...
                                        <md-slider ng-disabled="!drawing.params.enableShadow" aria-label="shadow blur"
                                                   step="1" ng-model="drawing.params.shadowOffsetY"
                                    ...
                                    <div class="colorpicker">
                                        <div class="colorpicker-label"><span>Color</span></div>
                                        <input ng-disabled="!drawing.params.enableShadow"
                                               ng-model="drawing.params.shadowColor"
                                               start-color="@{{ drawing.params.shadowColor }}"
                                               ed-color-picker="drawing.setShadowProperty('color', color)" type="text"/>
                                    </div>

                                    <div class="buttons">
                                        <md-button ng-click="finishAddingDrawingsToCanvas()"
                                                   class="md-primary md-raised">Save
                                        </md-button>
                        ...
                        <section id="filters" class="tab" data-index="4" ng-controller="FiltersController">
                            ...
                            <div class="filters-list row" ed-pretty-scrollbar ed-scroll-axis="y"
                                 ed-scroll-theme="light">
                                <figure ng-class="{ applied: filters.filterAlreadyApplied(filter.name) }"
                                    ...
                                    <div class="filter-image">
                                        <img ng-src="pixie/images/filters/@{{ filter.name.toLowerCase() }}.png"
                                             class="img-responsive md-whiteframe-z1"/>
                                        <div ng-class="{ 'remove-only': !filter.options }"
                                             class="remove-filter-overlay">
                                ...
                                <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                                    ...
                                    <div ng-repeat="(key,value) in filters.lastAppliedFilter.options">
                                        ...
                                        <section ng-if="!value.colorpicker && !value.select">
                                            <div class="md-slider">
                                                <div class="slider-label">@{{ key == filters.lastAppliedFilter.name ?
                                                    'amount' : key }}
                                                </div>
                                                <md-slider
                                                        md-discrete
                        ...
                        <section id="simple-shapes" class="tab" data-index="5" ng-controller="SimpleShapesController">
                            ...
                            <div class="actions-menu md-whiteframe-z1" ng-class="isPanelEnabled() ? 'open' : 'closed'">
                                <div class="menu-header"><h3>@{{ shapes.selected.displayName || shapes.selected.name
                                        }}</h3></div>
                                ...
                                <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                                    ...
                                    <section id="object-fills">
                                        ...
                                        <div class="fill-activator">
                                            ...
                                            <input ed-discrete
                                                   start-color="@{{ shapes.selected.options.main.fill.current }}"
                                    ...
                                    <div ng-repeat="group in shapes.selected.options | orderOptions" class="clearfix">
                                        ...
                                        <div ng-if="group.name !== 'main'" class="heading-with-switcher">
                                            ...
                                            <md-switch class="md-switch"
                                                       ng-model="shapes.selected.options[group.name].enabled"
                                        ...
                                        <div ng-repeat="(optionName, option) in group">
                                            ...
                                            <section ng-if="option.type === 'slider'">
                                                <div class="md-slider">
                                                    <div class="slider-label">@{{ option.displayName || optionName }}
                                                    </div>
                        ...
                        <section id="stickers" class="tab" data-index="6" ng-controller="StickersController">
                            ...
                            <div data-name="stickers" class="actions-menu md-whiteframe-z1"
                                ...
                                <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                                    ...
                                    <div class="slider-input">
                                        <input type="number" ng-change="setOpacity(opacity)" step="0.1" min="0.1"
                                               max="1" ng-model="opacity"/>
                                    </div>
                            ...
                            <div ed-pretty-scrollbar ed-scroll-axis="y" ed-scroll-theme="light" ed-stickers-categories
                                ...
                                <section ng-repeat="category in categories" class="sticker-category-container">
                                    <div class="category-header" data-name="@{{ category.name }}">@{{ category.name }}
                                    </div>
                                    <div class="category-stickers"
                                        ...
                                        <div ng-repeat="doodle in category.items track by $index"
                                            ...
                                            <img class="img-responsive"
                                                 data-src="pixie/images/stickers/@{{category.name}}/@{{$index+1}}.@{{ category.type }}"/>
                                        </div>
                                    </div>
                                </section>
                            </div>
                ...
                <section id="viewport">
                    <section id="top-panel" class="md-whiteframe-z1" ng-controller="TopPanelController">
                        <md-button ng-click="openNewCanvasDialog($event)" {{-- ng-if="!getParam('hideOpenButton')"--}}>
                            New
                        </md-button>
                        <md-button ng-click="openUploadDialog($event)" ng-if="!getParam('hideOpenButton')">Add Image
                        </md-button>
                        <md-button ng-class="{ inactive: !historyPanelOpen }"
                                   ng-click="toggleRightPanel('history', $event)">History
                        </md-button>
                        <md-button ng-class="{ inactive: !objectsPanelOpen }"
                                   ng-click="toggleRightPanel('objects', $event)">Layers
                        </md-button>
                ...
                <div id="bottom-bar" ng-controller="ZoomController">
                    <section class="zoom-container md-whiteframe-z1">
                        ...
                        <div class="zoom-slider">
                            <md-slider aria-label="zoom" step="1" ng-model="zoom" ng-change="doZoom()"
                                       min="@{{ minScale }}" max="@{{ maxScale }}"></md-slider>
                        </div>
                ...
                <script src="{{ asset('pixie/js/scripts.min.js') }}"></script>
                    ...
                    <md-bottom-sheet class="bottom-sheet gradients-sheet">
                        <div class="items-list" ed-pretty-scrollbar>
                            <div ng-repeat="g in shapes.gradients"
                                 ng-style="{background: 'url(pixie/images/gradients/'+($index+1)+'.png)'}"
                    ...
                    <md-bottom-sheet class="bottom-sheet images-sheet">
                        ...
                        <div class="items-list" ed-pretty-scrollbar>
                            <div ng-repeat="t in shapes.textures track by $index"
                                 ng-style="{background: 'url(pixie/images/textures/'+$index+'.png)'}"
                                 ng-click="shapes.fillWithImage('pixie/images/textures/'+$index+'.png')"
                ...
                <script type="application/ng-template" id="save-image-dialog">
                    <md-dialog class="upload-file-dialog save-dialog">
                        <md-input-container>
                            ...
                            <input type="text" ng-model="imageName" id="image-name" placeholder="Choose image name"
                                   autofocus>
                        </md-input-container>
                        ...
                        <md-radio-group ng-model="imageType">
                            ...
                            <md-radio-button value="json">InstoreX</md-radio-button>
                        </md-radio-group>

                        <div ng-if="imageType === 'jpeg'">
                            <div class="slider-label">Quality @{{ imageQuality }}</div>
                            <md-slider aria-label="Angle" md-discrete ng-model="imageQuality" step="1" min="1"
                                       max="10"></md-slider>
                        </div>

                        <p ng-if="imageType === 'json'">This will save a file with current editor state so you can
                            load it later.</p>
                        --}}
                        <div id="folders"></div>
                        <md-button ng-disabled="enableSaveButton()" id="save-image" ng-click="saveImage($event)"
                    ...
                    <md-dialog class="upload-file-dialog">
                        ...
                        <div class="new-canvas" ng-show="openImageMode === 'create'">
                            ...
                            <div class="buttons">
                                ...
                                <md-button ng-click="createNewCanvas(canvasWidth, canvasHeight)"
                ...
                <script type="application/ng-template" id="main-start-create-image">
                    <md-dialog class="upload-file-dialog">
                        {{--
                        <div ng-show="openImageMode === 'open'">
                            <md-input-container>
                        ...
                        <div class="new-canvas">
                            {{--
                    <h2><span>Open existing</span></h2>
                    <md-select
                            ng-model="openImageUrl"
                            placeholder="Pick one"
                            ng-change="showImagePreview(openImageUrl)">
                        @foreach ($imageResources as $imageResource)
                        <md-option ng-value='{!! json_encode($imageResource->resource)!!}'>{{ $imageResource->name }} - {{ $imageResource->created_at }}</md-option>
                        @endforeach
                    </md-select>
                        ...
                        <div class="new-canvas">
                            <h2><span>Select template size</span></h2>

                            @foreach ($templateSizes as $size)

                                <div>
                                    <md-button ng-click="createNewCanvas({{ $size['w'] }}, {{ $size['h'] }})"
